...
class VectorStore:
    ...
    def __init__(self,
        ...
        print("reranker模型初始化：",self.reranker)
        ...
        print("embedding模型初始化：", self.embedding_function)
    ...
    def add_documents(self, documents):
        ...
        for i, doc in enumerate(documents):
            ...
            # 32位的16进制数组成的随机的码，生成的种子是doc.page_content.encode('utf-8')，如果两段内容完全一样，生成id也一样。
            # 会不会重复，理论上会，实际上不会。
